...
[EIP-2935](https://eips.ethereum.org/EIPS/eip-2935) requires a system contract to be deployed. This network transaction,

To deploy this contract, a deposit transaction is created with the following attributes:
...
This results in the Fjord GasPriceOracle contract being deployed to `0x0F792be4B0c0cb4DAE440Ef133E90C0eCD48CCCC`,
to verify:
